...
`src/main/understanding_fulcro/client.cljs` contains the code to start and refresh
...
application `understanding-fulcro.development-preload`. You can add code here that
...
```
lein uberjar
java -jar target/understanding_fulcro.jar
```
